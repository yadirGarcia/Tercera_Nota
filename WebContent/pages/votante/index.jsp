...
<title>${votante == null ? "Registrar" : "Actualizar"}Votante</title>
</head>
<body>
	...
	<div class="container" style="margin-top: 4em">
		<form class="well form-horizontal"
			action="${votante != null ? 'votante?accion=edit' : 'votante?accion=insert'}"
			method="post" id="formulario-elecciones-1">
			<fieldset>
				<legend>
					<c:out value="${votante == null ? 'Registrar' : 'Actualizar'}"></c:out>
					Votante
				</legend>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${votante.id}" id="id" placeholder="id"
								class="form-control" type="text">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4 control-label">Estamento</label>
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-list"></i></span> <select name="estamento"
								id="estamento" class="form-control selectpicker">
					...
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								<option
									value="${votante != null ? votante.tipodocumentoBean.id : ''}">${votante != null ? votante.tipodocumentoBean.id : "Seleccione Una"}</option>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${votante.documento}" id="documento"
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${votante.nombre}" id="nombre" placeholder="Nombre"
								class="form-control" type="text">
						</div>
					</div>
				</div>
					...
					<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								...
								value="${votante.email}" id="email" placeholder="Email"
								class="form-control" type="text">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-4 selectContainer">
						<div class="input-group">
							<span class="input-group-addon"><i
								class="glyphicon glyphicon-list"></i></span> <select name="procesos"
								id="procesos" class="form-control selectpicker">
								<option
									value="${votante != null ? votante.eleccionBean.id : ''}">${votante != null ? votante.eleccionBean.id : "Seleccione Una"}</option>
