...
<body>
	...
	<div class="container" style="margin-top: 3em">
		<h3 class="text-center title" style="margin-top: 1em; margin-bottom: 2em">Votantes</h3>
			...
			<tbody>
				<c:forEach var="u" items="${list}">
					<tr>
						...
						<td><c:out value="${u.tipodocumentoBean.desripcion}"></c:out></td>
						<td><c:out value="${u.eleccionBean.nombre}"></c:out></td>

						<td><a
							href="votante?accion=showEdit&&votante=<c:out value = '${u.id}' />">Editar
						</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
							href="votante?accion=delete&&votante=<c:out value='${u.id}' />">Delete</a></td>
				</c:forEach>
			</tbody>
		</table>
	</div>
